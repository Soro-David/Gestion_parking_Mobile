...
class _AgentParkingScreenState extends State<AgentParkingScreen> {
  // Données mockées des stationnements en cours
  ...
  Widget build(BuildContext context) {
    // Filtrer les stationnements par immatriculation (plaque)
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => ParkingDetailScreen(data: data),
            ),
          );
        },
        child: Container(
