...
class _ParkingDetailScreenState extends State<ParkingDetailScreen> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Affichage de la plaque d'immatriculation (Style CEMAC/Cameroun)
                        Container(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: isActive ? Colors.greenAccent.withOpacity(0.12) : Colors.redAccent.withOpacity(0.12),
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 40,
              decoration: BoxDecoration(
                color: assetPath != null ? Colors.white : color.withOpacity(0.12),
                borderRadius: BorderRadius.circular(10),
              ),
  ...
  void _processPayment(String method) {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      ...
      final String exitTimeStr = '${now.hour.toString().padLeft(2, '0')}:${now.minute.toString().padLeft(2, '0')}';

      setState(() {
        _isProcessing = false;
        _data['statut'] = 'termine';
        _data['heureSortie'] = exitTimeStr;
      });
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'La sortie du véhicule ${_data['plaque']} a été validée avec succès à $exitTimeStr via ${_getPaymentMethodName(method)}. L\'emplacement (${_data['place']}) est désormais libéré.',
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      color: AppTheme.textSecondary,
                      fontSize: 13,
  ...
  Widget _buildTimeSelectButton({required int minutes, required int current, required ValueChanged<int> onTap}) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppTheme.secondary : Colors.white.withOpacity(0.04),
          borderRadius: BorderRadius.circular(12),
