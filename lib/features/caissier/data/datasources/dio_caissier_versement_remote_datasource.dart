...
import 'caissier_versement_remote_datasource.dart';

class DioCaissierVersementRemoteDataSource implements CaissierVersementRemoteDataSource {
  DioCaissierVersementRemoteDataSource({Dio? dio}) : _dio = DioClient.create(dio);
