...
import 'package:parking_mobile/features/caissier/presentation/providers/caissier_versement_provider.dart';

class CaissierDetailVersementScreen extends StatefulWidget {
  final int versementId;

  const CaissierDetailVersementScreen({super.key, required this.versementId});

  @override
  State<CaissierDetailVersementScreen> createState() =>
      _CaissierDetailVersementScreenState();
}

class _CaissierDetailVersementScreenState
    extends State<CaissierDetailVersementScreen> {
  late Future<VersementDetail> _futureDetail;

  @override
  void initState() {
    super.initState();
    _futureDetail = CaissierVersementProvider.repository
