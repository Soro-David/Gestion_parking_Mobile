...
class CaissierSettingsScreen extends StatefulWidget {
  const CaissierSettingsScreen({super.key});

  @override
  State<CaissierSettingsScreen> createState() => _CaissierSettingsScreenState();
}

class _CaissierSettingsScreenState extends State<CaissierSettingsScreen> {
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildGroupedCard(
                  ...
                  children: [
                    _tileWithoutContainer(Icons.person_outline_rounded, context.translate('profile_caissier'), () {
                    ...
                    _tileWithoutContainer(Icons.notifications_none_rounded, context.translate('notifications'), () {
                      context.push(AppRoutes.caissierNotifications);
                    }, Colors.white, isInverse: true),
                    _buildDivider(Colors.white.withValues(alpha: 0.15)),
                    _tileWithoutContainer(Icons.lock_outline_rounded, context.translate('security'), () {
                      context.push(AppRoutes.caissierSecurity);
                    }, Colors.white, isInverse: true),
                  ],
                ),
