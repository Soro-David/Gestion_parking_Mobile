...
/// Écran notifications Caissier — redirige vers les pages partagées
class CaissierNotificationsScreen extends StatelessWidget {
  const CaissierNotificationsScreen({super.key});
