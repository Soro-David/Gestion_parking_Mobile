...
class CaissierSortieScanScreen extends StatefulWidget {
  const CaissierSortieScanScreen({super.key});

  @override
  State<CaissierSortieScanScreen> createState() => _CaissierSortieScanScreenState();
}

class _CaissierSortieScanScreenState extends State<CaissierSortieScanScreen> {
  final CaissierStationnementRepository _repository = DioCaissierStationnementRepository();
  ...
  Future<void> _searchAndNavigateToDetail() async {
    ...
    try {
      ...
      if (matchedSession != null) {
        ...
        // Navigate to details
        context.push(AppRoutes.caissierStationnementDetail, extra: matchedSession);
      } else {
