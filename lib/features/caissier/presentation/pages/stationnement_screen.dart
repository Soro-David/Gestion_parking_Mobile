      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              context.push(AppRoutes.caissierStationnementDetail, extra: data).then((_) { _loadHistory(); });
            },
            child: Container(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    height: 48,
                    decoration: BoxDecoration(
                      color: isEnCours ? Colors.greenAccent.withValues(alpha: 0.5) : Colors.white.withValues(alpha: 0.5),
