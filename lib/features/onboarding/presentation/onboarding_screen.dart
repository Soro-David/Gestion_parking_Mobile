                      ...
                      children: List.generate(3, (index) {
                        ...
                        return AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isActive ? AppTheme.secondary : Colors.white.withOpacity(0.2),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 1; i <= 3; i++) {
      ...
      final ringPaint = Paint()
        ..color = AppTheme.secondary.withOpacity(0.07 * (4 - i) * animFactor)
    ...
    final gridPaint = Paint()
      ..color = Colors.white.withOpacity(0.04 * animFactor)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.0;
    ...
    final pinGlow = Paint()
      ..color = AppTheme.accent.withOpacity(0.2 * animFactor)
      ..style = PaintingStyle.fill;
    ...
    final carGlow = Paint()
      ..color = AppTheme.primary.withOpacity(0.3 * animFactor)
      ..style = PaintingStyle.fill;
...
class GatePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final laserGlow = Paint()
      ..color = AppTheme.secondary.withOpacity(0.3 * animFactor)
      ..strokeWidth = 10
      ..style = PaintingStyle.stroke;
    ...
    final qrPaint = Paint()
      ..color = Colors.white.withOpacity(0.7 * animFactor)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 2.0;
    ...
    final qrCorePaint = Paint()
      ..color = Colors.white.withOpacity(0.8 * animFactor)
      ..style = PaintingStyle.fill;
    ...
    final bitPaint = Paint()
      ..color = Colors.white.withOpacity(0.3 * animFactor)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 2.0;
...
class PaymentPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final cardBorder = Paint()
      ..color = Colors.white.withOpacity(0.12 * animFactor)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.5;
    ...
    canvas.drawCircle(Offset(cardRect.right - 35, cardRect.bottom - 30), 12, Paint()..color = Colors.white.withOpacity(0.25)..style = PaintingStyle.fill);
    canvas.drawCircle(Offset(cardRect.right - 25, cardRect.bottom - 30), 12, Paint()..color = AppTheme.accent.withOpacity(0.3)..style = PaintingStyle.fill);
    ...
    final clockGlow = Paint()
      ..color = AppTheme.accent.withOpacity(0.12 * animFactor)
      ..style = PaintingStyle.fill;
    ...
    canvas.drawCircle(checkCenter, 20 * animFactor, Paint()..color = Colors.green[400]!.withOpacity(0.2)..style = PaintingStyle.fill);
