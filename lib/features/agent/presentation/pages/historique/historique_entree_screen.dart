...
class HistoriqueEntreeScreen extends StatefulWidget {
  final bool isActive;
  const HistoriqueEntreeScreen({super.key, this.isActive = false});
...
class _HistoriqueEntreeScreenState extends State<HistoriqueEntreeScreen> {
  ...
  @override
  void didUpdateWidget(covariant HistoriqueEntreeScreen oldWidget) {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              context.push(AppRoutes.agentEntreeDetail, extra: e);
            },
            child: Container(
