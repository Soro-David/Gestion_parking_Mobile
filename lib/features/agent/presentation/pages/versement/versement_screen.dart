...
class _AgentVersementScreenState extends State<AgentVersementScreen> {
	late Future<List<Versement>> _futureVersements;
	...
	Widget _buildVersementItem(BuildContext context, Versement v) {
		final isValide = v.status.toLowerCase() == 'validé' || v.status.toLowerCase() == 'valide' || v.status.toLowerCase() == 'paid';
		...
		return GestureDetector(
			onTap: () {
				context.push(AppRoutes.agentVersementDetail, extra: v.id);
			},
			child: Container(
