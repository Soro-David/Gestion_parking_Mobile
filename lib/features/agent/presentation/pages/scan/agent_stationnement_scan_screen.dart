...
class AgentStationnementScanScreen extends StatefulWidget {
  final CameraController? controller;
  final Future<void>? initializeFuture;

  const AgentStationnementScanScreen({
    super.key,
    this.controller,
  ...
  @override
  State<AgentStationnementScanScreen> createState() =>
      _AgentStationnementScanScreenState();
}

class _AgentStationnementScanScreenState
    extends State<AgentStationnementScanScreen> {
  // ── Dépendances ─────────────────────────────────────────────────
  final AgentStationnementRepository _repository =
