...
import '../../../../roles/agent/presentation/home/home_screen.dart';
import '../../../../roles/caissier/presentation/dashboard/home_screen.dart';
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (userModel.role == UserRole.agent) {
          ...
          destination = const CaissierHomeScreen();
        } else {
  ...
  Widget _buildEmailField() {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isFocused ? AppTheme.secondary : Colors.white.withOpacity(0.08),
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(
            ...
            color: isFocused ? AppTheme.secondary : Colors.white.withOpacity(0.4),
            size: 22,
          ),
            ...
            children: [
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: _rememberMe ? AppTheme.secondary : Colors.white.withOpacity(0.04),
                  border: Border.all(
                    color: _rememberMe ? AppTheme.secondary : Colors.white.withOpacity(0.2),
                    width: 1.5,
                  ),
                ),
                child: _rememberMe
  ...
  Widget _buildStatusOverlay(Size size) {
    return Container(
      ...
      child: BackdropFilter(
        filter: ColorFilter.mode(Colors.black.withOpacity(0.2), BlendMode.dstATop),
        child: Center(
  ...
  Widget _buildSuccessOverlay() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.green[400]!.withOpacity(0.3), width: 1.5),
        boxShadow: [
          BoxShadow(
